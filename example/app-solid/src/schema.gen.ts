...
// Generated on: 2025-10-28 11:58:08 UTC
...
/**
 * Helper type to extract relationship field names for a specific table
 */
export type RelationshipFieldsFor<TableName extends keyof Relationships> = Relationships[TableName][number]["field"];
...
export const RELATIONSHIPS: Relationships = {
    user: [
        { field: "comments", table: "commented_on", cardinality: "many" },
    ],
    comment: [
        { field: "thread", table: "thread", cardinality: "one" },
        { field: "author", table: "user", cardinality: "one" },
    ],
    thread: [
        { field: "author", table: "user", cardinality: "one" },
        { field: "comments", table: "commented_on", cardinality: "many" },
