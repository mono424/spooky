...
This starts SurrealDB, the SSP sidecar, applies migrations, and runs your app dev server — all in one command. If your apps have a `dev` field configured in `sp00ky.yml`, those are started too. See the [Dev Server](/docs/backend/dev-server) page for details.
