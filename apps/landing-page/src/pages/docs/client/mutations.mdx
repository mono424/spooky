...
title: Mutations
description: Create, update and delete. Writes land locally first, then sync. Your UI never waits on the network.
---

import CodeBlock from '../../../components/ui/CodeBlock.astro';
import Warning from '../../../components/ui/Warning.astro';

export const code3 = `import { RecordId, Uuid } from 'surrealdb';
