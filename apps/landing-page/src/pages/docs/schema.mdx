...
export const code2 = `# Generate TypeScript types
spky --input src/schema.surql --output schema.gen.ts --format typescript

# Or generate all formats at once
spky --input src/schema.surql --output schema --all`;
