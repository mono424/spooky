...
Once your schema is defined, running `spooky generate` will automatically generate TypeScript definitions for you. You don't need to manually write interfaces.
