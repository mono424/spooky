...
In Spooky, you define your data model using **SurrealQL** schema files. This approach serves as the single source of truth for your application, from which TypeScript interfaces are automatically generated.
...
-- 4. Create the relationship using standard SurrealQL or Events
