...
The [admin dashboard](/docs/reference/admin-dashboard#workflows-schedules-and-jobs) offers two ways to run a workflow again, and they are not the same thing:
