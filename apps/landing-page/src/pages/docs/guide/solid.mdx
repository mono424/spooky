...
<Note>
  This is the Solid **1.x** binding (`@spooky-sync/client-solid`). Apps on the Solid 2.0 RC use
  `@spooky-sync/client-solid2` instead — see the [Solid 2 guide](/docs/guide/solid2).
</Note>
