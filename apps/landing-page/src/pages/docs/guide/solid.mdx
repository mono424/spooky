...
export const code7 = `npm install @spooky-sync/client-solid surrealdb`;

export const code6 = `# Generate TypeScript types from your schema
spky --input src/schema.surql --output src/schema.gen.ts --format typescript`;

export const code5 = `import { SyncedDb, type SyncedDbConfig } from '@spooky-sync/client-solid';
...
export const code4 = `import { createSignal, onMount, Show } from 'solid-js';
...
export const code3 = `import { For } from 'solid-js';
...
export const code1 = `import { Uuid } from 'surrealdb';
import { db } from './db';
