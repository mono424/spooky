...
<CodeBlock code={`spky migrate create "add_user_avatar"`} lang="bash" />
...
<CodeBlock code={`spky migrate apply`} lang="bash" />
...
<CodeBlock code={`spky migrate status`} lang="bash" />
...
<CodeBlock code={`spky migrate create "bootstrap_schema" --schema ./schema.surql`} lang="bash" />
