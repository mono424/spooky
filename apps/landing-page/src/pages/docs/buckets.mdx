...
Buckets provide a type-safe file storage abstraction for uploading, downloading, and managing files in your Spooky application. They integrate directly with your SurrealDB schema for permission control and with the Spooky CLI for guided setup.
...
Reference your bucket files in `spooky.yml`:
...
The CLI generates the `.surql` file and updates your `spooky.yml` automatically.
...
Access a bucket from your `SpookyClient` or `SyncedDb` instance:
