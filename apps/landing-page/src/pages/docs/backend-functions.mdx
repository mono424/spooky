...
All forms support an optional `workdir` field that is resolved relative to the project root (the directory containing `spooky.yml`). If omitted, commands run from the project root.
