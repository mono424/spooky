...
<Note title="Teams">
The first team member to run <code>env unlock</code> creates the tenant vault. Other members receive vault access through the invitation flow — they set their own passphrase when accepting the invitation. See <a href="/docs/cloud/vault">Shared Vault</a> for details.
</Note>
