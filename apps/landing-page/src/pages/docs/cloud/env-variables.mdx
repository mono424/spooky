...
export const code29 = `spky cloud env init`;
...
export const code25 = `spky cloud env list`;
...
export const code23 = `spky cloud env delete DATABASE_URL`;

export const code22 = `spky cloud env import .env`;

export const code21 = `spky cloud env change-passphrase`;
...
export const code19 = `rm ~/.sp00ky/vault-passphrase`;

export const code18 = `spky cloud env <COMMAND>
