...
title: Backups
description: Create, list and restore database snapshots, and schedule them to run automatically.
---
...
spky backup restore <backup-id>`;

export const code9 = `# Create a backup
spky backup create

# Create a named backup
spky backup create --name before-migration`;

export const code8 = `spky backup list`;
...
export const code6 = `spky backup restore <backup-id>`;

export const code5 = `spky backup delete <backup-id>`;

export const code4 = `# Enable daily backups at 2 AM, keep last 7
spky backup configure --enabled true --schedule "0 2 * * *" --retention 7

# Disable automatic backups
spky backup configure --enabled false

# Change retention to keep 30 backups
spky backup configure --retention 30`;

export const code3 = `spky backup reset`;

export const code2 = `spky backup reset --no-backup`;

export const code1 = `spky backup <COMMAND>
