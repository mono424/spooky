...
2.  **Engine Registration**: The engine registers the query and computes the *initial state*.
3.  **Metadata Upsert**: Saves view metadata (`clientId`, `ttl`, `surrealQL`) to `_spooky_incantation`.
